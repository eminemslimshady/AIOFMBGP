...
public class PullToRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private PRListViewListener mListener;
    ...
    private void initWithContext(Context context) {
        ...
        // init header view
        mHeader = new ListHeaderView(context);
     ...
     * @param listener
     */
    public void setXListViewListener(PRListViewListener listener) {
        mListener = listener;
    }
    ...
    public void autoRefresh() {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) {
            ...
            if (mHeader.getVisibleHeight() > mHeaderHeight) {
                mHeader.setState(ListHeaderView.STATE_READY);
            } else {
                mHeader.setState(ListHeaderView.STATE_NORMAL);
            }
        }

        mPullRefreshing = true;
        mHeader.setState(ListHeaderView.STATE_REFRESHING);
        refresh();
    }
     ...
     * @author markmjw
     */
    public interface PRListViewListener {
